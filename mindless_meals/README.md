...
Schema changes go through Alembic migrations (`app/migrations/`)
rather than one big schema file — see `docs/database.md` for the full
schema, ERD, and how to import the existing recipes into the
normalized ingredient list (`flask import-ingredients`).
